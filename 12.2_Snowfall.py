...
class MyGame(arcade.Window):
    def __init__(self, width, height, title):
        ...
        self.flake_list = []  # Make list to hold snowflakes
    ...
    def on_draw(self):
        ...
        for flake in self.flake_list:
            flake.draw_flake()
        # Make window pane
        arcade.draw_rectangle_filled(SW // 2, SH // 2, 10, SH, arcade.color.ALLOY_ORANGE)  # Vertical
        arcade.draw_rectangle_filled(SW // 2, SH // 2, SW, 10, arcade.color.ALLOY_ORANGE)  # Horizontal
