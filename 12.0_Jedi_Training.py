...
flips the horizontal axis of the ballw
7.) What does this code do?  self.pos_y += self.dy
takes the ball's old position, and adds the momentum to it.
8.) What is the width of the window?
640
9.) What is this code checking?  self.pos_y > SH - self.rad:
If the ball is too far down it won't go down further
10.) What is this code checking? if self.pos_x < self.rad
If the ball is too far to the left, it won't go further
