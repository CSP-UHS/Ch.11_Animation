...
dx and dy are velocities, changing the variable changes the direction it moves and speed
...
It makes x move backwards or in the opposite direction
...
if the ball is hitting the ceiling
